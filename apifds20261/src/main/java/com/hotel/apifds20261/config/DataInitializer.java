...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedParametros() {
        ...
        seedParametro("hotel.maxNochesHospedaje", "30", "Máximo de noches permitido en check-in directo", "datos-hotel");
        seedParametro("hotel.logo", "", "Logo del hotel en base64", "datos-hotel");
    }
    ...
    private void seedUsuarios() {
        // Solo se crean los usuarios por defecto si no existen.
        // NUNCA se reasigna la contrasena en cada arranque: si el administrador
        // cambio su clave en el sistema, esta debe mantenerse entre reinicios.
        if (!usuarioRepository.existsByUsername("admin")) {
            ...
            System.out.println("Usuario ADMIN creado (contrasena inicial admin123). Cambiela al primer ingreso.");
        }
        ...
        if (!usuarioRepository.existsByUsername("recepcionista")) {
            ...
            System.out.println("Usuario RECEPCIONISTA creado (contrasena inicial recep123).");
        }
    }
}

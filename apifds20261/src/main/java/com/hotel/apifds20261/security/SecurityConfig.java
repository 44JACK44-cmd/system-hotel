...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/parametro/uploadlogo").hasAnyRole("ADMIN", "RECEPCIONISTA")
                ...
                .requestMatchers(HttpMethod.POST, "/api/usuario/uploadavatar/**").hasAnyRole("ADMIN", "RECEPCIONISTA")
                .requestMatchers(HttpMethod.PATCH, "/api/usuario/updateprofile/**", "/api/usuario/cambiarpassword/**", "/api/usuario/tema/**").hasAnyRole("ADMIN", "RECEPCIONISTA")
    ...
    public CorsFilter highPriorityCorsFilter() {
        CorsConfiguration config = new CorsConfiguration();
        config.setAllowedOrigins(List.of(allowedOrigins.split(",")));
        config.setAllowedMethods(List.of("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"));
        config.setAllowedHeaders(List.of("*"));

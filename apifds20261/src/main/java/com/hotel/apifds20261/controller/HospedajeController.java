...
public class HospedajeController {
    ...
    public ResponseEntity<ResponseHospedaje> actionDeudasPendientes() {
        List<HospedajeResponse> list = hospedajeBusiness.listarDeudasPendientes();
        ResponseHospedaje response = new ResponseHospedaje();
        response.success();
        response.setListHospedaje(list);
        return ResponseEntity.ok(response);
    ...
    public ResponseEntity<List<SuggestionResponse>> actionSuggestions(@RequestParam String termino) {
        List<SuggestionResponse> list = hospedajeBusiness.buscarSugerencias(termino);
        return ResponseEntity.ok(list);
    }

    @GetMapping("search")
    public ResponseEntity<ResponseHospedaje> actionSearch(@RequestParam String valor) {
        List<HospedajeResponse> list = hospedajeBusiness.searchActivos(valor);
        ResponseHospedaje response = new ResponseHospedaje();
        response.success();
        response.setListHospedaje(list);
        return ResponseEntity.ok(response);

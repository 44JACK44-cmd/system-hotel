...
import { Perfil } from './page/auth/perfil/perfil';
import { Actividad } from './page/auth/actividad/actividad';
import { RecepcionConfiguracion } from './page/auth/recepcion-configuracion/recepcion-configuracion';
...
export const routes: Routes = [
  ...
  { path: 'actividad', component: Actividad, canActivate: [AuthGuard] },
  ...
  // Recepcionista panel
  {
    ...
    children: [
      ...
      { path: 'configuracion', component: RecepcionConfiguracion },
